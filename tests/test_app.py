...
def test_remove_from_activity_rejects_unknown_activity():
    # Arrange
    activity_name = "Unknown Club"
    email = "student@mergington.edu"
...
def test_remove_from_activity_rejects_unknown_participant():
    # Arrange
    activity_name = "Chess Club"
    email = "student@mergington.edu"
...
def test_remove_from_activity_requires_email():
    # Arrange
    activity_name = "Chess Club"
